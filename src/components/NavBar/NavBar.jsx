            ...
            <div className="h-full flex items-center">
              <ul className="pr-12 md:flex items-center h-full hidden">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="focus:outline-none border-b-2 border-transparent leading-none cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-600 border-b-2 border-white"
                  >
                    Home
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="javascript:void(0)"
                    className="focus:outline-none border-b-2 border-transparent leading-none cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-600"
                  >
                    Resource Manager
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="javascript:void(0)"
                    className="focus:outline-none border-b-2 border-transparent leading-none cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-600 mr-14"
                  >
                    Job Applications
                  </a>
                </li>
                ...
                <div className="flex md:hidden items-center justify-end">
                  <div className="flex items-center">
                    <div className="h-full flex items-center">
                      <button
                        aria-label="show notifications"
                        className="relative focus:outline-none focus:text-indigo-700 hover:text-indigo-700 focus:border-indigo-700 hover:border-indigo-700 h-full flex items-center justify-center text-gray-600 cursor-pointer"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="icon icon-tabler icon-tabler-bell"
              ...
              <div className="h-full flex items-center">
                <ul className="flex items-center h-full md:hidden">
                  ...
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="focus:outline-none border-b-2 border-transparent leading-none cursor-pointer h-full flex items-center hover:text-indigo-700 text-sm text-gray-600 mr-4"
                    >
                      Job Applications
                    </a>
                  </li>
