    ...
    return (
      <div>
        <div className="relative">
          ...
          <input onChange={e => setSearch(e.target.value.toLowerCase())} className="hidden bg-gray-700 bg-opacity-10 md:block focus:outline-none focus:border-indigo-700 w-42 rounded text-sm pl-8 py-2 placeholder-gray-200 text-gray-400" type="text" placeholder="Search here" />
        </div>
      </div>
    );
}
